...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/nerdtree,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after
set scrolloff=8
set shiftwidth=4
set showtabline=2
set smartindent
...
silent! normal! zE
let s:l = 102 - ((28 * winheight(0) + 16) / 32)
...
normal! 0
tabnext 1
badd +102 Solution.java
badd +0 template.java
badd +0 later.java
badd +9 input.txt
badd +0 output.txt
badd +1 term
badd +0 resources/modInv.java
badd +0 resources/ncr.java
badd +0 resources/fenwickTree.java
badd +0 resources/segmentTree.java
